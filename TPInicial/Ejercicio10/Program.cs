...
namespace Ejercicio10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int tk;
            int cant;
            int[] M = new int[5]; //uso M[0] PARA ACUMULAR MONTO TOTAL 
            int motomin;
            int prom = 0;
            int pora = 0;
            ...
            while (tk != 0)
            {
                Console.WriteLine("ingrese la categoria de pizza (de 1 a 6)"); cat = Convert.ToInt32(Console.ReadLine()); Console.WriteLine("ingrese la cantidad"); cant = Convert.ToInt32(Console.ReadLine()); Console.WriteLine("ingrese la moto"); moto = Convert.ToInt32(Console.ReadLine()); monto = cant * PRECIO[cat];
                if (tkmax == 0)
                {
                    tkmax = tk; motomax = moto; montomax = monto;
                }
                else
                {
                ...
                Console.WriteLine("INGRESE EL NRO DE TICKET"); tk = Convert.ToInt32(Console.ReadLine()); //VUELVO a pedir ingreso de ticket para que ingrese el proximo
            }//fin ingreso
